...
class test_addPermission(ParametrizedTestCase):
    def test_addPermission(self):
        ...
        self.baseParams = {"permissions":"1000,1011,1012,1005,100501,10050101,10050102,10050103,10050104,1005010401,"
                                         ...
                                         "100505,1017,101701,101702,1010,101003,101001,101002,101004,10100401,10100402,"
                                         "10100403,10100404,10100405,10100406,101005,100106,100106,1004,100401,100402,"
                                         "100403,100404,100822,1001,100101,100102,10010201,10010202,100103,1002,100201,"
                                         "100202,100203,100204,1007,100702,100701,100703,100704,1008,100801,100802,"
                                         "100803,100804,100805,100809,100810,100811,100812,100813,100814,100815,100816,"
                                         "100817,100818,100819,100819,100820,100821,100822,1013,101301,101302,1014,"
                                         "101401,101403,101402,1015,101501,101502,101504,1016,101601,101602,101604,"
                                         "1018,101801,101802,1009,100916,100917,100918,100911,100905,100904,100908,"
                                         "100909,100910,100915,"}
        if self.roleName == '':
