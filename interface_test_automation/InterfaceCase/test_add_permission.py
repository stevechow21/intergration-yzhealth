...
class test_addPermission(ParametrizedTestCase):
    def test_addPermission(self):
        ...
        self.baseParams = {"permissions":"1000,1005,100501,100502,100503,100504,10050401,10050402,10050403,10050404,"
                                         "10050405,10050406,1001,100101,100102,10010201,10010202,100103,1002,100201,"
                                         "100202,100203,100204,1010,101001,101002,101003,101004,1003,1004,100401,"
                                         "100402,100403,100404,1007,100702,100701,100703,1008,100801,100802,100803,"
                                         "100804,100805,100809,100810,100811,100812,100813,100814,100815,100816,100817,"
                                         "100818,100819,100820,1009,100904,100905,100906,100907,100908,"}
        if self.roleName == '':
