...
#### 后台操作-添加上转
class test_addUpTransfer(ParametrizedTestCase):
    def test_addUpTransfer(self):
        ...
        self.baseParams = {"primaryDiagnosis":"AUTO diagnose","outPeason":"AUTO history",
                           "previousHistory":"","treatmentProcess":"",
                           "medicalHistory":"[{\"relativePath\":\"medicalHistory/90b6152c69784747b4bc35e77d3b39c7.jpg\","
        ...
        if self.isNew == 'Y':
            ...
            self.transferParams = {
                ...
                'archiveBirthday': self.archiveBirthday,
                'contact': '',
                'contactPhone': '',
